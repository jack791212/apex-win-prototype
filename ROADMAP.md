...
由自我進化引擎（intel/ 三個 skill：radar → investigate → evolve，外加打磨相位 consolidate）持續更新建議；**建造 vs 打磨的比重由 `intel/CONTROL.md` 的 `mode` 控制**，需真錢/牌照的功能一律延後。
...
## 🟢 NOW（純前端 · S · 把死按鈕變真功能）
- [x] 遊戲卡「試玩 / 真錢」雙模式按鈕與標示 ✅ 2026-06-23（#11）
...
- [x] Rakeback 返水即時回饋 ✅ 2026-06-23（#8）
- [x] 百家樂 / 輪盤 RNG 桌 → 主播跟注接真開獎（取代 Math.random Demo）✅ 2026-06-23（#7，7a→7d 全段）
- [x] 真實累積彩金 Jackpot（demo 獎池遞增 + 命中演出）✅ 2026-06-23（#9）
- [x] PWA（manifest + Service Worker）✅ 2026-06-23（#14）
