...
145. ✅完成（本輪落地，2026-08-29 平台軌 14:00 窗） **登錄表的「同 id 再註冊」是整筆取代，於是 #80 延遲載入把 seed 的開發者暱稱靜默洗掉——25 款可玩遊戲裡有 5 款的作者從此不存在，而大廳的「🎨 我們的開發者」名單看起來完全正常** — S — 來源：**平台軌 08-29 14:00 窗台帳輪替「功能」上半（遊戲引擎與聚合 × 可驗證公平 × 中央掛鉤 × VIP × 點數商城 …）＋ #144「漏斗只保證總額、不保證歸屬」形制的反向搜尋**
