...
174. ⬜待批准 **提款面板告訴玩家「預計到帳時間 48 小時內」，然後在同一個 tick 把錢扣掉、記成一筆已完成的歷史、跳出「已提款」——那 48 小時從來沒有發生過** — M｜來源：platform-modules 台帳「金流」新增格〈交易狀態面／到帳事件〉absent ＋ **取材維度 15**（2026-09-06 新開）＋ bet365／Rollbit 兩站同輪到期、方向相反、指到同一格
    - **問題（機械事實，全可複跑）**：
