...
- **規模**（🔄 2026-09-14 遊戲軌·22:00 窗重量）：`prototype/src/core/` **74** 檔、`prototype/src/views/` **37** 個 view 檔、首屏 **95** 支 script；自我檢測 **408** 項 fast（`node prototype/tests/run.js`）＋ **16** 項 deep（`--deep --group games`）。`sw.js` CACHE 現 **v317**（2026-09-15 遊戲軌 16:00 窗 bump：#36 動了 `views/table-moneywheel.js` 與 `styles/game-money-wheel.css` ＝出貨位元組）。〔舊記載：views 36／390 項／v312；406 項／v316〕
