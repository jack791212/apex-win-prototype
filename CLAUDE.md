...
- **規模**：`prototype/src/core/` 69 檔、`prototype/src/views/` 34 個 view 檔、首屏 91 支 script；自我檢測 **370 項**（`node prototype/tests/run.js`）。`sw.js` CACHE 現 **v290**。
