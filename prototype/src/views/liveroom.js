    ...
    return el("div", { class: "ax-liveroom ax-fade-in" }, [
      ...
      el("div", { class: "ax-liveroom__grid" }, [
        ...
        el("div", { class: "ax-liveroom__side" }, [
          ...
          chatBox,
          el("div", { class: "ax-chat__input" }, [input, el("button", { class: "ax-chat__send", text: "➤", title: "送出", "aria-label": "送出", onClick: function () { if (input.value.trim()) { addChat({ name: "你", text: input.value.trim() }); input.value = ""; } } })])
        ])
      ])
    ]);
  }
