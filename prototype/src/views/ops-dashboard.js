...
(function (global) {
  ...
  var STATIC_RISKS = [
    "暗影儀式 Shadow Ritual：無強制 RTP 模型（96.13% 僅前端標示），派彩由 client 隨機 → 負 GGR 風險無上限。",
    "救濟金 Faucet：每 8h 可領且無終身上限 → 真金模式為無上限營運成本。",
    "紅利流水倍數 WAGER_MULT=1：紅利近乎零門檻即可解鎖套現。",
    "bounty_mine RPC 派彩信任前端傳入 p_maxmult → 可印錢漏洞，真金上線前必修。",
    "多項送幣直入主餘額（救濟金/每日簽到/返水/JP 命中）→ 真金模式可即時提走，需流水/KYC 閘。"
  ];
