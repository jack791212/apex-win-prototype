...
(function (global) {
  ...
  var DICT = {
    ...
    "輪次": "Round",
    "決勝": "Final",
    "再戰一局（同設定）{p}": "Rematch (same setup) {p}",
    "收下 {a}": "Collect {a}",
    "🤝 榜首平手 {n} 人 · 公平抽籤裁決 roll={r}（可在外框 🔒 驗算）": "🤝 {n}-way tie at the top · settled by provably fair draw roll={r} (verify via 🔒 above)",
    "🤝 榜首平手 {n} 人 · 由伺服器裁決": "🤝 {n}-way tie at the top · settled by the server",
    ...
    // 遊戲 view toast 整節點 EN 覆蓋補漏（維護軌 2026-08-29 escape① i18n 覆蓋審計·全 src toast() 掃描·皆整節點非 P3 串接；arena/bounty/casino/chicken/game-frame/global-prize/moles/pump/liveroom/slot）
    "尚無對戰紀錄，先去打一場！": "No battle records yet — go play a match!",
    "餘額不足以支付押金 + 開房費": "Not enough balance for the stake + room fee",
    "最多選 5 款遊戲": "Pick up to 5 games", "對戰已建立，開始配對！（Demo）": "Battle created — matchmaking started! (Demo)",
    "本場次數已用盡": "You're out of rounds for this session",
    "已切換真金模式（提款待牌照）": "Switched to real-money mode (withdrawals pending license)",
    "伺服器忙線，請再按一次出發": "Server busy — press Go again", "伺服器忙線，請再試一次": "Server busy — please try again",
    "本輪已在伺服器結束，已重新同步": "This round already ended on the server — resynced",
    "伺服器未部署小雞開獎服務，改為練習模式": "Chicken draw service not deployed — switching to practice mode",
    "實時統計 即將推出": "Live stats coming soon", "已切換子母畫面 · 可拖曳": "Picture-in-picture on · draggable",
    "已關閉子母畫面（未完成的回合視為棄局）": "Picture-in-picture closed (unfinished round counts as a forfeit)",
    "已開啟本期開獎提醒（Demo 假提醒）": "Draw reminder on for this round (Demo mock reminder)",
    "至少命中一隻再兌現": "Hit at least one mole before cashing out",
    "至少打一次氣再兌現": "Pump at least once before cashing out",
    ...
    // Emerald Sprite 翡翠妖精（slot · games 軌 09-13 第 27 款＝首款 cluster-adjacency 相鄰連通計分；樣式與程式同批延遲載入 #189）
    "🧚 翡翠妖精 Emerald Sprite": "🧚 Emerald Sprite", "翡翠妖精 Emerald Sprite": "Emerald Sprite",
    ...
    "有效押注": "Wagered", "最大贏額": "Biggest Win", "最高倍數": "Highest Multiplier", "倍數總和": "Total Multiplier",
    ...
    "限時賽期內，每一局的獲勝倍數逐局累加即為你的成績。": "During the timed period, your score is the sum of your winning multipliers, round by round.",
    ...
    // #176B 合格遊戲（範圍與權重向 HL.wagerScope 求值；每個 preset 一句，新增 preset 就要補一句）
    "合格遊戲": "Eligible games",
    "本期不限遊戲：任何一款遊戲的有效押注都全額計分。": "No game restriction this period: valid wagers on any game count in full.",
    "本期只計 SLOT 類遊戲：其他類別的押注不列入本期成績，也不影響名次。": "Only SLOT games count this period: wagers on other categories are excluded from your score and your rank.",
    "本期只計 Originals 類遊戲：其他類別的押注不列入本期成績，也不影響名次。": "Only Originals count this period: wagers on other categories are excluded from your score and your rank.",
    "本期採標準權重：SLOT 與 Originals 全額計分，桌上與真人遊戲以一成計分。": "Standard weighting this period: SLOT and Originals count in full; table and live games count at 10%.",
    // #176 賽事名稱（原本 5 個名字一個都沒進字典＝旗艦活動的名字對英文玩家一直是繁中）
    "週末 Slots 衝刺賽": "Weekend Slots Sprint", "黃金時段積分賽": "Prime Time Points Race", "Originals 大亂鬥": "Originals Melee",
    ...
    "⬇ 匯出 CSV": "⬇ Export CSV", "已匯出 CSV": "CSV exported", "匯出失敗（未寫出檔案）": "Export failed (no file was written)",
    "清空紀錄": "Clear history",
    ...
    "這張報表讀取時出錯，暫時無法顯示或匯出。": "This report failed to load, so it cannot be shown or exported right now.",
    ...
    "紅利流水單注上限": "Max bet while wagering a bonus",
    "本筆紅利的流水單注上限": "Max bet while wagering this bonus",
    "（超過的單注不累進流水，但不擋下注、不影響餘額與派彩）": "(bets above this do not count toward wagering; they are not blocked and your balance and payouts are unaffected)",
    "本注未計入紅利流水": "This bet did not count toward bonus wagering",
    "不限": "No limit",
    ...
    "這間房剛剛滿了，改為觀戰（Demo）": "That room just filled up — switching to spectate (Demo)",
    "回競技場挑一間還有空位的房，或觀戰。": "Head back to the Arena for a room with an open seat, or spectate.",
    "這間房已經滿了，你沒有位子。": "This room is full — there's no seat for you.",
    "🔒 私密房": "🔒 Private room",
    "🔒 私密房：他人無法加入（Demo 觀戰）。": "🔒 Private room: nobody else can join (spectate only, Demo).",
    "私密房間 Private": "Private room",
    "他人無法加入": "Nobody else can join",
