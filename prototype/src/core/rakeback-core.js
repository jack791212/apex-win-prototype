...
(function (global) {
  ...
  var EDGE_PCT = {
    demo: [0.238148, 0.379092, 0.520037, 0.661953, 0.850527],
    live: [0.046657, 0.069986, 0.093315, 0.117616, 0.140945]
  };

  /* 校準基準＝edge 表的**款數平均莊優**。這個常數不是裝飾：`rakeback/cost-neutral-*`
   * 兩鎖用「平均莊優 × 本表比例」對照舊制成本，**edge 表一長，平均就漂，兩鎖就會紅**。
   * 2026-09-13（#189·abyssal-surge 上架，23→24 款）：平均 2.0586 → 2.117833，
   *   故本表兩列同乘 0.97203116（＝舊平均/新平均）⇒ **玩家實得返水逐位維持改表前的水準**
   *   （這是重跑校準，不是放寬鎖；比例本身被等比縮小，成本中性因此才守得住）。 */
  var CALIB_MEAN_EDGE_PCT = 2.117833;  // 校準基準（#50 EDGE 表 24 款平均），改表時需重跑校準
