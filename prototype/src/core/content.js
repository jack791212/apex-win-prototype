...
(function (global) {
  ...
  var SEED = [
    ...
    { id: "lobby:rakeback", type: "lobby-promo",
      payload: { tag: "天天回饋", title: "每日返水 1.5%", sub: "當日下注自動回饋彩金", ic: "💰", c1: "#16345f", c2: "#36a6ff", go: "rakeback" },
    ...
    { id: "lobby:arena-rake", type: "lobby-promo",
      payload: { tag: "限時活動", title: "對押池抽水減半", sub: "競技場狂歡，現在加入", ic: "⚔️", c1: "#6e1e3a", c2: "#ff5d6c", go: "arena" },
    ...
    { id: "lobby:vip", type: "lobby-promo",
      payload: { tag: "尊榮禮遇", title: "VIP 俱樂部開放", sub: "升級解鎖專屬獎勵", ic: "💎", c1: "#13524a", c2: "#2fd17a", go: "vip" },
    ...
    { id: "lobby:weekend", type: "lobby-promo",
      payload: { tag: "週末加碼", title: "週末充值送彩金", sub: "儲值最高加贈 50%", ic: "🎁", c1: "#5f4a13", c2: "#ffb524", go: "reload" },
    ...
    { id: "lobby:referral", type: "lobby-promo",
      payload: { tag: "好友同樂", title: "推薦好友共享獎勵", sub: "邀請越多，回饋越多", ic: "🤝", c1: "#3a1e6e", c2: "#9d80ff", go: "referral" },
