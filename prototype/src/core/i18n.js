...
(function (global) {
  ...
  var HANS = {
    ...
    "本週已用": "本周已用",
    // 註：「本月已用」四字簡繁完全相同 ⇒ **刻意不宣告**（HANS 字典只列與繁體不同者；宣告等值鍵＝無作用的死鍵，DEBT U31 同型）。
    //   附帶觀察交維護軌：本檔既有的 "今日已用": "今日已用"（上方）是同型的等值冗餘鍵，屬 i18n 維度既存項，本輪不跨軌改。
    "冷靜期進行中，暫停儲值": "冷静期进行中，暂停储值",
    "未設定": "未设置", "輸入數值": "输入数值", "套用": "应用", "今日已用": "今日已用",
