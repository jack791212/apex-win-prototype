...
build_lock: false           # ← 遊戲軌 07-30 10:04 建置輪（g-100451-2d96）已於 10:2x 收尾釋放：消化船長 G5 之 2/3（① 輪盤大/小標反改正 ② 百家對子升級 canonical 8 副牌靴 RTP 92.31%→89.64%·8M+40M MC 13/13 重驗全過）＋更正 G4 誤判（baccarat/roulette 補入 PF 🔒 白名單）；剩餘 G5③ 四 slot 賠付表 UI 留專輪。sw v114→v115。以下為歷史釋放註記：
