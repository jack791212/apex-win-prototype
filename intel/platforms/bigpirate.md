...
## 🔄 2026-08-05 複查（tier-3 逾期 4 天·本批 priority 最高 69）

Adventure Mode 島戰 meta（前輪主軸）本輪維持不變、無新事實。本輪火力放在**先前未觸及的忠誠層**，取得兩條結構性事實：

- ⭐ **① 五段 VIP 的升段來源＝「遊玩」＋「選購 GC 幣包」兩條**（購買行為本身即累積等級進度）。
  - → **與 Spree 獨立收斂**（Spree 的 XP 亦來自遊玩＋買幣包，08-05 前輪查得並開成 **#65 進度來源註冊表**）⇒ **#65 自單點觀察升級為兩平台共識**，已回寫卡片來源欄。
- ⭐ **② VIP 給的多半不是錢、是服務**：生日禮、**24/7 真人客服**、**專屬 VIP 客戶經理**（Lv3 Buccaneer 起）、專屬幣包優惠、Share of the Plunder／Free Rum。
